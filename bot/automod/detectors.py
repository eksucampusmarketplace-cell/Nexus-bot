...
def detect_message_frequency(user_id: int, chat_id: int,
                              window_sec: int = 10,
                              threshold: int = 8) -> tuple[bool, int]:
    """
...
async def detect_profanity(text: str, chat_id: int, 
                           custom_words: list[str] = None) -> bool:
    """
