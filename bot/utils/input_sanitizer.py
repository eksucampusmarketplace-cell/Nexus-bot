...
def validate_input(
    ...
    if check_sql:
        ...
        if is_sql:
            ...
            return (
                ...
                {"type": "sql_injection", "patterns": sql_matches},
            )
    ...
    if check_command:
        ...
        if is_cmd:
            ...
            return (
                ...
                {"type": "command_injection", "patterns": cmd_matches},
            )
    ...
    if check_spam:
        ...
        if is_spam:
            ...
            return (
                False,
                f"Input appears to be spam: {spam_reason}",
                {"type": "spam", "reason": spam_reason},
            )
    ...
    if check_keywords:
        ...
        if keywords:
            ...
            return (
                False,
                f"Input contains restricted keywords: {', '.join(keywords)}",
                {"type": "dangerous_keywords", "keywords": keywords},
            )
...
def validate_multiple_inputs(
    inputs: Dict[str, Any], rules: Dict[str, Dict[str, Any]]
    ...
    for field_name, field_value in inputs.items():
        ...
        if not is_valid:
            all_valid = False
            errors[field_name] = {"message": error_msg, "details": details}
